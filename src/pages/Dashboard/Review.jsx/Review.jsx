...
import { FaStar, FaPen, FaQuoteLeft, FaHeart, FaCheckCircle, FaTimes } from "react-icons/fa";
...
const Reviews = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        e.target.reset();
        setFormData({ name: "", details: "", rating: 0 });
    };
                ...
                {showSuccessModal && (
                    <div className="fixed inset-0 bg-black/30  bg-opacity-50 flex items-center justify-center z-50 px-4">
                        <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl relative overflow-hidden">
                            ...
                            <div className="absolute top-0 left-0 w-32 h-32 bg-green-100 rounded-full -ml-16 -mt-16 opacity-50 blur-2xl"></div>
                            <div className="absolute bottom-0 right-0 w-32 h-32 bg-amber-100 rounded-full -mr-16 -mb-16 opacity-50 blur-2xl"></div>
                            ...
                            <div className="text-center relative z-10">
                                ...
                                <p className="text-gray-500 text-sm mb-6 leading-relaxed">
                                    Your valuable feedback helps us serve you better. We truly appreciate you taking the time to share your experience with us.
                                </p>
                                
                                {/* Star Decoration */}
                                <div className="flex items-center justify-center gap-2 text-amber-500 mb-6">
                                    <FaStar className="animate-bounce" style={{ animationDelay: '0s' }} />
                                    <FaStar className="animate-bounce" style={{ animationDelay: '0.1s' }} />
                                    <FaStar className="animate-bounce" style={{ animationDelay: '0.2s' }} />
                                    <FaStar className="animate-bounce" style={{ animationDelay: '0.3s' }} />
                                    <FaStar className="animate-bounce" style={{ animationDelay: '0.4s' }} />
                                </div>
                                
                                {/* Close Button */}
                                <button
                                    onClick={() => setShowSuccessModal(false)}
                                    className="w-full bg-gradient-to-r from-amber-600 to-orange-600 text-white py-3 rounded-xl font-semibold hover:from-amber-700 hover:to-orange-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                                >
                                    Close
                                </button>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center justify-center space-x-3 bg-gradient-to-r from-amber-50 to-orange-50 py-6 rounded-2xl border-2 border-amber-100">
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            <FaStar
                                                key={star}
                                                className={`cursor-pointer text-4xl transition-all transform hover:scale-125 ${
